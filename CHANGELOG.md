...
## [15.0.0-alpha.12](https://github.com/blackbaud/skyux/compare/15.0.0-alpha.11...15.0.0-alpha.12) (2026-09-05)
...
* **components/charts:** do not skip category labels for horizontal bar charts ([#4670](https://github.com/blackbaud/skyux/issues/4670)) ([0fbe997](https://github.com/blackbaud/skyux/commit/0fbe997ba1b6e23ef7ccfa2f4b20ad22473c19aa)), closes [AB#4094199](https://dev.azure.com/blackbaud/Products/_workitems/edit/4094199)
...
* **components/tabs:** fit layout tabs should not shift with hidden tabs ([#4471](https://github.com/blackbaud/skyux/issues/4471)) ([#4472](https://github.com/blackbaud/skyux/issues/4472)) ([4c6c857](https://github.com/blackbaud/skyux/commit/4c6c85723dccf9ea89984c14b628457e77cc08c8)), closes [AB#4024923](https://dev.azure.com/blackbaud/Products/_workitems/edit/4024923)
...
* release 14.0.0 ([#4359](https://github.com/blackbaud/skyux/issues/4359)) ([38bb018](https://github.com/blackbaud/skyux/commit/38bb018c9df4aab831d8d693ade1771aa30d340d))
...
* **components/ag-grid:** apply minimum height override to column container ([#4333](https://github.com/blackbaud/skyux/issues/4333)) ([#4335](https://github.com/blackbaud/skyux/issues/4335)) ([123c4b0](https://github.com/blackbaud/skyux/commit/123c4b094789dd70fb805b2191f574fab0f8a99a)), closes [AB#3926782](https://dev.azure.com/blackbaud/Products/_workitems/edit/3926782)
...
## [13.0.0-alpha.4](https://github.com/blackbaud/skyux/compare/13.0.0-alpha.3...13.0.0-alpha.4) (2025-08-08)


### ⚠ BREAKING CHANGES

* **components/forms:** remove deprecated `icon` input from checkboxes in favor of `iconName` ([#3802](https://github.com/blackbaud/skyux/issues/3802))
* **components/forms:** remove deprecated `icon` input from radios in favor of `iconName` ([#3796](https://github.com/blackbaud/skyux/issues/3796))
* remove modern v1 support from sectioned form, split view, tabs, text editor, theme, tile, toast, and vertical tabs ([#3787](https://github.com/blackbaud/skyux/issues/3787))
* remove modern v1 support from alert, box, card, chevron, description list, expansion indicator, filter, infinite scroll, inline form, label, paging, repeater, status indicator, sort, toolbar, and wait ([#3785](https://github.com/blackbaud/skyux/issues/3785))
* **components/layout:** remove deprecated `iconType` input from the action button icon in favor of `iconName` ([#3793](https://github.com/blackbaud/skyux/issues/3793))
* remove modern v1 support from autocomplete, confirm, country field, dropdown, lookup, modal, navbar, phone field, popover, progress indicator, and search ([#3786](https://github.com/blackbaud/skyux/issues/3786))
* **components/data-manager:** remove deprecated `icon` input from the data view config in favor of `iconName` ([#3792](https://github.com/blackbaud/skyux/issues/3792))
* remove modern v1 support from character count, checkbox, data manager, datepicker, field group, file attachment, file drop, flyout, input box, radio, selection box, timepicker, and toggle switch ([#3783](https://github.com/blackbaud/skyux/issues/3783))
* remove modern v1 support from ag-grid, avatar, colorpicker, summary action bar, and tree view ([#3780](https://github.com/blackbaud/skyux/issues/3780))

### Features

* add container background color to default theme ([#3732](https://github.com/blackbaud/skyux/issues/3732)) ([#3745](https://github.com/blackbaud/skyux/issues/3745)) ([dd2f79b](https://github.com/blackbaud/skyux/commit/dd2f79b23c2d286fc29e30f02bdf98c8f64b1b33))
...
* **components/data-manager:** remove deprecated `icon` input from the data view config in favor of `iconName` ([#3792](https://github.com/blackbaud/skyux/issues/3792)) ([bb84f57](https://github.com/blackbaud/skyux/commit/bb84f57508250da387f00cc7dde797d3b5cd4da7))
* **components/forms:** checkbox uses a component token to set its border radius in modern theme ([#3763](https://github.com/blackbaud/skyux/issues/3763)) ([#3775](https://github.com/blackbaud/skyux/issues/3775)) ([a34afb2](https://github.com/blackbaud/skyux/commit/a34afb2f455dcf78b46bf8ad6b1a2126b5ca4599))
* **components/forms:** disabled state icon colors in modern v2 ([#3791](https://github.com/blackbaud/skyux/issues/3791)) ([#3794](https://github.com/blackbaud/skyux/issues/3794)) ([f3f84c1](https://github.com/blackbaud/skyux/commit/f3f84c1fe815176cbbdb83dd250013fb69cbb27e))
* **components/forms:** remove deprecated `icon` input from checkboxes in favor of `iconName` ([#3802](https://github.com/blackbaud/skyux/issues/3802)) ([73e55d7](https://github.com/blackbaud/skyux/commit/73e55d769bdc46071fc4f474462e19153ffa7146))
* **components/forms:** remove deprecated `icon` input from radios in favor of `iconName` ([#3796](https://github.com/blackbaud/skyux/issues/3796)) ([a7d24ae](https://github.com/blackbaud/skyux/commit/a7d24aefd80894d0ee74eb3e41610bb230e2ddaa))
...
* **components/lists:** tokenize list view grid styles ([#3751](https://github.com/blackbaud/skyux/issues/3751)) ([472ba60](https://github.com/blackbaud/skyux/commit/472ba60af2d407fdb6355eb4182fd498b3f05bc9))
* **components/lookup:** lookup no longer displays a search icon when `showMore` is not enabled ([#3714](https://github.com/blackbaud/skyux/issues/3714)) ([20ea8df](https://github.com/blackbaud/skyux/commit/20ea8df174a05c091957522989a2787ed8beb999))
* **components/packages:** create schematic to convert page-summary to page-header ([#3784](https://github.com/blackbaud/skyux/issues/3784)) ([#3789](https://github.com/blackbaud/skyux/issues/3789)) ([9f7a681](https://github.com/blackbaud/skyux/commit/9f7a681f2d29d65842b25372feec5d4eeca8fe40))
* **components/split-view:** add responsive padding around repeater in split view drawer ([#3747](https://github.com/blackbaud/skyux/issues/3747)) ([#3777](https://github.com/blackbaud/skyux/issues/3777)) ([abc3379](https://github.com/blackbaud/skyux/commit/abc3379c16fc18fa12be63bf7be74e8db5c54c3e))
...
* **components/theme:** allow undefined value to be passed to SkyThemeService.setThemeBrand() to clear branding ([#3760](https://github.com/blackbaud/skyux/issues/3760)) ([#3762](https://github.com/blackbaud/skyux/issues/3762)) ([0604cb5](https://github.com/blackbaud/skyux/commit/0604cb5cb03735e0444d4952f621aa00c81b727d))
* **components/theme:** update tokens from `page` to `layout`  ([#3761](https://github.com/blackbaud/skyux/issues/3761)) ([#3772](https://github.com/blackbaud/skyux/issues/3772)) ([17c6bce](https://github.com/blackbaud/skyux/commit/17c6bce1188c5988b41c6fdf917a9d995e9be7eb))
...
* use gradient background for selected switches in modern v2 ([#3788](https://github.com/blackbaud/skyux/issues/3788)) ([#3790](https://github.com/blackbaud/skyux/issues/3790)) ([78e15af](https://github.com/blackbaud/skyux/commit/78e15afbe278634c5b7de6d655f84ba39287eb8c))
...
* **components/datetime:** timepicker buttons use a set size in v2 modern ([#3742](https://github.com/blackbaud/skyux/issues/3742)) ([#3755](https://github.com/blackbaud/skyux/issues/3755)) ([9166dd3](https://github.com/blackbaud/skyux/commit/9166dd33e39701eaa4b174331fc95f01334649f8))
* **components/forms:** radio buttons do not use interactive styling when checked in v2 modern ([#3746](https://github.com/blackbaud/skyux/issues/3746)) ([#3754](https://github.com/blackbaud/skyux/issues/3754)) ([403aa5b](https://github.com/blackbaud/skyux/commit/403aa5b6be4f0647f709d468a2274735be9597f8))
* **components/forms:** selection box uses interactive states in v2 modern ([#3736](https://github.com/blackbaud/skyux/issues/3736)) ([#3758](https://github.com/blackbaud/skyux/issues/3758)) ([05b1fab](https://github.com/blackbaud/skyux/commit/05b1fab3855da58d0dc339ffa79db44d7d588530))
...
* **components/lookup:** search uses secondary border and background color tokens in v2 modern ([#3759](https://github.com/blackbaud/skyux/issues/3759)) ([#3768](https://github.com/blackbaud/skyux/issues/3768)) ([05b4ca8](https://github.com/blackbaud/skyux/commit/05b4ca8672094ca7e397ac20c1392ae12473a1fd))
...
* **components/theme:** components using the layout host use component tokens for link area margin ([#3740](https://github.com/blackbaud/skyux/issues/3740)) ([#3750](https://github.com/blackbaud/skyux/issues/3750)) ([e7d3172](https://github.com/blackbaud/skyux/commit/e7d31722e060eca160255860e6b2b5dee0979b84))
...
* **components/tiles:** tile box shadows are not clipped on xs breakpoints and block layout host configurations ([#3748](https://github.com/blackbaud/skyux/issues/3748)) ([#3752](https://github.com/blackbaud/skyux/issues/3752)) ([b49bcde](https://github.com/blackbaud/skyux/commit/b49bcde81da789fd6c0636b753c8c48c20e79a76))
...
## [13.0.0-alpha.1](https://github.com/blackbaud/skyux/compare/13.0.0-alpha.0...13.0.0-alpha.1) (2025-07-17)


### Features

* add input and input button elevations ([#3631](https://github.com/blackbaud/skyux/issues/3631)) ([#3634](https://github.com/blackbaud/skyux/issues/3634)) ([0702890](https://github.com/blackbaud/skyux/commit/070289080cfb9569ce48059718c07946c16447cc))
* button and dropdown elevations ([#3610](https://github.com/blackbaud/skyux/issues/3610)) ([#3618](https://github.com/blackbaud/skyux/issues/3618)) ([7256b5b](https://github.com/blackbaud/skyux/commit/7256b5b7d48c23d60316f05ed4bf2cdbc41d54cb))
* **components/icon:** upgrade icons library to version 9 ([#3635](https://github.com/blackbaud/skyux/issues/3635)) ([#3638](https://github.com/blackbaud/skyux/issues/3638)) ([300683b](https://github.com/blackbaud/skyux/commit/300683bf32be129aa4200d760961e78758a23231))
* **components/layout:** remove secondary button overrides in modern v2 toolbar ([#3643](https://github.com/blackbaud/skyux/issues/3643)) ([#3662](https://github.com/blackbaud/skyux/issues/3662)) ([3ae03fe](https://github.com/blackbaud/skyux/commit/3ae03fe7188a70ca03c384492acd1ba1e76c4e23))
* **components/packages:** create schematic to convert definition list to description list ([#3570](https://github.com/blackbaud/skyux/issues/3570)) ([39e8087](https://github.com/blackbaud/skyux/commit/39e80870fe36567580d98b2a456d5f8496e40893))
* **components/theme:** add brand registry with URL and SRI hash ([#3633](https://github.com/blackbaud/skyux/issues/3633)) ([#3649](https://github.com/blackbaud/skyux/issues/3649)) ([ccd4b80](https://github.com/blackbaud/skyux/commit/ccd4b80d2dd992774c582563e4332a10a635f17a))
* replace container tokens ([#3577](https://github.com/blackbaud/skyux/issues/3577)) ([#3583](https://github.com/blackbaud/skyux/issues/3583)) ([24f396e](https://github.com/blackbaud/skyux/commit/24f396e3c53413ae69f6d726735712fbc481fba2))
...
* update link highlight token ([#3584](https://github.com/blackbaud/skyux/issues/3584)) ([#3640](https://github.com/blackbaud/skyux/issues/3640)) ([d0c208b](https://github.com/blackbaud/skyux/commit/d0c208bdcb75223d25dacd2bd4b9afe815d4c1fb))
* use reference tokens for public API ([#3601](https://github.com/blackbaud/skyux/issues/3601)) ([#3605](https://github.com/blackbaud/skyux/issues/3605)) ([57e8797](https://github.com/blackbaud/skyux/commit/57e87975868dd414bf1d5676c81b86ed78f09796))


### Bug Fixes

* buttons in toolbars use specific elevation tokens in v2 modern ([#3664](https://github.com/blackbaud/skyux/issues/3664)) ([#3666](https://github.com/blackbaud/skyux/issues/3666)) ([369812a](https://github.com/blackbaud/skyux/commit/369812a66598fc7fd2c4d28a2321314b03e9e9b1))
* checkboxes, radios, and toggle switches use deemphasized label color when the switch is disabled in v2 modern ([#3665](https://github.com/blackbaud/skyux/issues/3665)) ([#3669](https://github.com/blackbaud/skyux/issues/3669)) ([10aec53](https://github.com/blackbaud/skyux/commit/10aec53c01d59a830a5d9628b6fbd33c84e80b72))
* **components/ag-grid:** sort icons use the small icon size ([#3597](https://github.com/blackbaud/skyux/issues/3597)) ([7750906](https://github.com/blackbaud/skyux/commit/7750906147f3f4b4b21f6f2f7abbabe58f49ad1e))
* **components/datetime:** month and year buttons in datepicker calendar use specific component tokens for padding ([#3661](https://github.com/blackbaud/skyux/issues/3661)) ([#3663](https://github.com/blackbaud/skyux/issues/3663)) ([8c565a1](https://github.com/blackbaud/skyux/commit/8c565a1c32a166a919deab0bc4adb83cb4b72aac))
* **components/flyout:** flyout header resize button uses `ew-resize` cursor ([#3644](https://github.com/blackbaud/skyux/issues/3644)) ([#3648](https://github.com/blackbaud/skyux/issues/3648)) ([c597b4c](https://github.com/blackbaud/skyux/commit/c597b4c3b53309f304f73571d7b72e5793efe364))
* **components/forms:** help inline is aligned with field group text in v2 modern ([#3608](https://github.com/blackbaud/skyux/issues/3608)) ([#3611](https://github.com/blackbaud/skyux/issues/3611)) ([014f705](https://github.com/blackbaud/skyux/commit/014f705a5210086830e902e9b61667eb672997a4))
* **components/forms:** indeterminate checkboxes use small icons in v2 modern ([#3624](https://github.com/blackbaud/skyux/issues/3624)) ([e073cc6](https://github.com/blackbaud/skyux/commit/e073cc68752fa1e1cd03655b79f5aef723afdf2c))
* **components/forms:** input box hint text and errors have left margin in v2 modern ([#3593](https://github.com/blackbaud/skyux/issues/3593)) ([#3607](https://github.com/blackbaud/skyux/issues/3607)) ([01e7390](https://github.com/blackbaud/skyux/commit/01e7390f4c0027f65f9964b3b56407b771eca312))
* **components/forms:** select inputs use updated icon in v2 modern ([#3626](https://github.com/blackbaud/skyux/issues/3626)) ([#3637](https://github.com/blackbaud/skyux/issues/3637)) ([9fb1c32](https://github.com/blackbaud/skyux/commit/9fb1c32f41ddaf7019e0e669c234c32b7554a2c8))
* **components/forms:** standalone checkboxes and radios use less hint text space in v2 modern ([#3645](https://github.com/blackbaud/skyux/issues/3645)) ([#3647](https://github.com/blackbaud/skyux/issues/3647)) ([74f5b26](https://github.com/blackbaud/skyux/commit/74f5b269c351db08d4e80501f1331178c022d73e))
* **components/help-inline:** help inline uses line icon for modern v2 ([#3596](https://github.com/blackbaud/skyux/issues/3596)) ([45c2918](https://github.com/blackbaud/skyux/commit/45c2918e662c68a55a9f7009b32b9fcd9633fb40))
* **components/lists:** remove hover and active state from `collapsible` items ([#3668](https://github.com/blackbaud/skyux/issues/3668)) ([#3676](https://github.com/blackbaud/skyux/issues/3676)) ([f78a2db](https://github.com/blackbaud/skyux/commit/f78a2db12c238beecca4fe7e766de570a8b4a338))
* **components/lists:** repeater title and checkbox are aligned in v2 when the item is selectable ([#3603](https://github.com/blackbaud/skyux/issues/3603)) ([#3614](https://github.com/blackbaud/skyux/issues/3614)) ([fb9824d](https://github.com/blackbaud/skyux/commit/fb9824d409a28eacf413759970f473a20fe89e1a))
* **components/lists:** selected sort item uses medium border width in v2 modern ([#3656](https://github.com/blackbaud/skyux/issues/3656)) ([#3660](https://github.com/blackbaud/skyux/issues/3660)) ([902ee0e](https://github.com/blackbaud/skyux/commit/902ee0e126597b707ff1cc1892903f25d43f0910))
...
* **components/lookup:** multi-select lookup does not have extra left value space in v2 modern when no tokens are present ([#3594](https://github.com/blackbaud/skyux/issues/3594)) ([#3602](https://github.com/blackbaud/skyux/issues/3602)) ([aafbd22](https://github.com/blackbaud/skyux/commit/aafbd2243ec9f3bd8294c3948b8d8bb839e8dcf5))
* **components/lookup:** search component uses deemphasized placeholder color in v2 modern ([#3646](https://github.com/blackbaud/skyux/issues/3646)) ([#3654](https://github.com/blackbaud/skyux/issues/3654)) ([32703bd](https://github.com/blackbaud/skyux/commit/32703bd32f68cf2a23f4ca06079fb068fe1da708))
* **components/modals:** fix punctuation in error messages ([#3589](https://github.com/blackbaud/skyux/issues/3589)) ([#3595](https://github.com/blackbaud/skyux/issues/3595)) ([16d80ff](https://github.com/blackbaud/skyux/commit/16d80ffefe3c16efaa81f6907a90998bccf84923))
...
* **components/packages:** remove unused schematics and rules ([#3642](https://github.com/blackbaud/skyux/issues/3642)) ([a1341a1](https://github.com/blackbaud/skyux/commit/a1341a14b28e9817cbff43238ae57fb76630fc18))
* **components/packages:** updated the `ng add` schematic to configure a workspace with a single project; workspaces with multiple projects should use the `add-skyux-to-project` schematic ([#3659](https://github.com/blackbaud/skyux/issues/3659)) ([233ded4](https://github.com/blackbaud/skyux/commit/233ded428fca3c1948896b8e97c3a7e1cdad349e))
* **components/split-view:** add background color to split view drawer and remove right border in v2 modern ([#3598](https://github.com/blackbaud/skyux/issues/3598)) ([#3599](https://github.com/blackbaud/skyux/issues/3599)) ([2f2763f](https://github.com/blackbaud/skyux/commit/2f2763fc73b5f6478cc682fdaf54408347575e21))
* **components/tabs:** tabs use new tab color tokens ([#3636](https://github.com/blackbaud/skyux/issues/3636)) ([#3639](https://github.com/blackbaud/skyux/issues/3639)) ([1085ace](https://github.com/blackbaud/skyux/commit/1085aceb49d2b44c49b0871a778d091e898f50a9))
* **components/tabs:** vertical tabs use nav border color tokens ([#3623](https://github.com/blackbaud/skyux/issues/3623)) ([#3632](https://github.com/blackbaud/skyux/issues/3632)) ([56fac32](https://github.com/blackbaud/skyux/commit/56fac323417f1721653d1106cab6f3377aec542c))
* **components/theme:** add box shadow to switch states ([#3613](https://github.com/blackbaud/skyux/issues/3613)) ([#3625](https://github.com/blackbaud/skyux/issues/3625)) ([f5cfd72](https://github.com/blackbaud/skyux/commit/f5cfd7202343d7dbfac5aa9fd4aa65e619634a38))
...
* selected horizontal and vertical tabs use medium border in v2 modern ([#3617](https://github.com/blackbaud/skyux/issues/3617)) ([#3627](https://github.com/blackbaud/skyux/issues/3627)) ([c85a428](https://github.com/blackbaud/skyux/commit/c85a42882d34bb332b43db7b8585314abfc1d689))
* update `google-libphonenumber` and `intl-tel-input` and fix Syrian and Kyrgyzstan flags for country and phone field components ([#3581](https://github.com/blackbaud/skyux/issues/3581)) ([6b6eb45](https://github.com/blackbaud/skyux/commit/6b6eb45c0f9ccb3aec60917b9460dd1a0f1a407e))
* update all linting dependencies ([#3585](https://github.com/blackbaud/skyux/issues/3585)) ([d7e4963](https://github.com/blackbaud/skyux/commit/d7e4963f4bc961731f8ba7a538bbb1bcf3577f1b))
* update border colors and remove list and fit layout horizontal space in v2 modern ([#3672](https://github.com/blackbaud/skyux/issues/3672)) ([#3675](https://github.com/blackbaud/skyux/issues/3675)) ([fb985eb](https://github.com/blackbaud/skyux/commit/fb985eb322cc823be40ab0e66b4e08e4fc531ccf))
* update various dependencies ([#3590](https://github.com/blackbaud/skyux/issues/3590)) ([2cda2b2](https://github.com/blackbaud/skyux/commit/2cda2b25209fb70254e4cdfbccef259b04fa9fbd))
...
* drop support for Angular 18 ([#2969](https://github.com/blackbaud/skyux/issues/2969))
* **components/ag-grid:** drop support for AG Grid 32 ([#3121](https://github.com/blackbaud/skyux/issues/3121))
* **components/core:** update querySelector method signature ([#3282](https://github.com/blackbaud/skyux/issues/3282))
* **components/forms:** revert `fileClick` event to no longer download attached file ([#3284](https://github.com/blackbaud/skyux/issues/3284)) The file attachment `fileClick` event will no longer download files for consumer. This change is reverting back to previous interactions where if a consumer does want clicking the name of a file to download it, they will have to hook into the `fileClick` event. Code examples have been reverted to showcase how to accomplish this.
...
* **components/manifest:** replace `@docsIncludeIds` with documentation.json files ([#3112](https://github.com/blackbaud/skyux/issues/3112)) ([ec60cba](https://github.com/blackbaud/skyux/commit/ec60cba50c25cd1f03ad05d62f50ecc414c0df92))
...
* add `@docsIncludeIds` to action bars, tree, autonumeric, avatar, colorpicker, core, datetime, errors, flyout, and forms packages ([#3074](https://github.com/blackbaud/skyux/issues/3074)) ([b5747b2](https://github.com/blackbaud/skyux/commit/b5747b22ff615d0b172a5fab0f653390d46e7890))
* add remaining `@docsIncludeIds` and validation steps ([#3076](https://github.com/blackbaud/skyux/issues/3076)) ([cb59851](https://github.com/blackbaud/skyux/commit/cb5985149dd13e40bb6bb6c4874a4551c36fb30d))
...
* implement `@docsId` and `@docsIncludeIds` JSDoc tags to capture documentation relationships in the manifest ([#3063](https://github.com/blackbaud/skyux/issues/3063)) ([ba33999](https://github.com/blackbaud/skyux/commit/ba33999f1ed289192bcc9f7b29db94397240c001))
* **sdk/skyux-eslint:** add linting rule to detect the use of legacy icons ([#3061](https://github.com/blackbaud/skyux/issues/3061)) ([1abcf12](https://github.com/blackbaud/skyux/commit/1abcf121d473eaa9ff335f41dd84507a72ee4aab))
