...
## [9.0.0](https://github.com/blackbaud/skyux/compare/v8.8.1...9.0.0) (2023-08-17)
...
* **components/ag-grid:** update documentation generation ([#1600](https://github.com/blackbaud/skyux/issues/1600)) ([9ae5395](https://github.com/blackbaud/skyux/commit/9ae5395260e7bce3701ee57ed2230687e35b5d7f))
...
* **components/indicators:** `SkyWaitService`'s `blockingWrap` and `nonBlockingWrap` methods now take in argument objects and the versions which take in an `Observable` are deprecated ([#922](https://github.com/blackbaud/skyux/issues/922)) ([36bd045](https://github.com/blackbaud/skyux/commit/36bd04507058c925a68c4a2cd778356b843defac))
