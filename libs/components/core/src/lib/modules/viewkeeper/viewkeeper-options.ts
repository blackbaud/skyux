...
export interface SkyViewkeeperOptions {
  ...
  /**
   * The scrollable parent which the viewkeeper resides in and should listen to and be
   * positioned within.
   */
  scrollableHost?: HTMLElement;

  /**
   * Whether to set the width of the viewkeeper element to the width of its
