...
export type { SkyIllustrationSize } from './lib/modules/illustration/illustration-size';
export { SkyIllustrationModule } from './lib/modules/illustration/illustration.module';

export type { SkyKeyInfoLayoutType } from './lib/modules/key-info/key-info-layout-type';
export { SkyKeyInfoModule } from './lib/modules/key-info/key-info.module';

export type { SkyLabelType } from './lib/modules/label/label-type';
export { SkyLabelModule } from './lib/modules/label/label.module';

export type { SkyIndicatorDescriptionType } from './lib/modules/shared/indicator-description-type';
export type { SkyIndicatorIconType } from './lib/modules/shared/indicator-icon-type';
...
export type { SkyToken } from './lib/modules/tokens/types/token';
export type { SkyTokenSelectedEventArgs } from './lib/modules/tokens/types/token-selected-event-args';
export type { SkyTokensMessage } from './lib/modules/tokens/types/tokens-message';
