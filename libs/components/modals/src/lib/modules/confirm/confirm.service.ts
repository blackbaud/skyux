...
/**
 * Launches a dialog.
 * @docsIncludeIds SkyConfirmConfig, SkyConfirmInstance, SkyConfirmType, SkyConfirmButtonConfig, SkyConfirmButtonStyleType, SkyConfirmCloseEventArgs, SkyConfirmHarness, SkyConfirmButtonHarnessFilters, SkyConfirmTestingModule, SkyConfirmTestingController, ModalsConfirmBasicWithControllerExampleComponent, ModalsConfirmBasicWithHarnessExampleComponent
 */
@Injectable({
  providedIn: 'root',
})
