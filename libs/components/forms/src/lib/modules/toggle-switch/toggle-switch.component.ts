  ...
  implements AfterContentInit, OnDestroy, ControlValueAccessor, Validator
{
  ...
  /**
   * Whether to disable the toggle switch. This input should not be used with reactive based forms and the disabled state should be set on the `FormControl` instead.
