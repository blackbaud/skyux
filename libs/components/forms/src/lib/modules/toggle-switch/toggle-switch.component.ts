...
{
  /**
   * An ARIA label for the toggle switch. This sets the toggle switch's `aria-label`
  ...
  /**
   * A tab index for the toggle switch. If not defined, the index is set to the position
