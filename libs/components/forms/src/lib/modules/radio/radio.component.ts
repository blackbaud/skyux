...
export class SkyRadioComponent implements OnDestroy, ControlValueAccessor {
  ...
  /**
   * An ARIA label for the radio button. This sets the radio button's `aria-label`
  ...
  /**
   * An icon to display in place of the radio button. To group radio buttons like in
  ...
  /**
   * A type to set the background color after users select an icon radio button.
