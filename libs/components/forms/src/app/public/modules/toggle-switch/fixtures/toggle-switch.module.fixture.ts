...
} from './toggle-switch-change-event.component.fixture';

import {
  SkyToggleSwitchFormDirectivesFixtureComponent
} from './toggle-switch-form-directives.component.fixture';

import {
  SkyToggleSwitchOnPushFixtureComponent
} from './toggle-switch-on-push.component.fixture';

import {
  SkyToggleSwitchReactiveFormFixtureComponent
} from './toggle-switch-reactive-form.component.fixture';

import {
  SkyToggleSwitchFixtureComponent
} from './toggle-switch.component.fixture';
