...
import { SkyAgGridWrapperComponent } from '../../../../../ag-grid/src/lib/modules/ag-grid/ag-grid-wrapper.component';
import { SkyAgGridHeaderComponent } from '../../../../../ag-grid/src/lib/modules/ag-grid/header/header.component';
...
describe('SkyAgGridComponent', () => {
  ...
  it('should destroy and recreate grid', async () => {
    ...
    await fixture.whenStable();
    expect(
      fixture.debugElement.queryAll(By.directive(SkyGridComponent)),
    ).toEqual([]);
    ...
    await fixture.whenStable();
    expect(
      fixture.debugElement.queryAll(By.directive(SkyGridComponent)).length,
    ).toEqual(4);
  });
