...
import { ITreeState, TreeModule, TreeNode } from '@blackbaud/angular-tree-component';
...
@Component({
  ...
  imports: [TreeModule, SkyAngularTreeContextMenuComponent, SkyCheckboxModule, SkyHelpInlineModule, SkyIconModule, NgTemplateOutlet]
})
