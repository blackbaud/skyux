...
export enum SkyCellType {
   ...
   * **Edit mode**
   * <br/>
   * That cells in the column will be edited as HTML text `inputs`. Any characters can be entered.
   * <br/><br/>
   * **Read-only mode**
   * <br/>
