...
export const AG_GRID_LOCALE_FR = {
  ...
  formulaParseInvalidCellReference:
    'Reference de cellule invalide : ${variable}.',
  ...
  formulaParseInternalUnexpectedFrameDuringReduction:
    'Erreur interne : frame inattendue pendant la reduction.',
  formulaParseInternalUnexpectedFrameBeforeOpenParen:
    "Erreur interne : frame inattendue avant '('.",
  formulaParseMisplacedComma: 'Virgule mal placee.',
  formulaParseCommaOutsideFunctionCall:
    'Virgule en dehors d un appel de fonction.',
  ...
  formulaParseFormulasMustBeginWithEquals:
    'Les formules doivent commencer par =.',
  formulaSerializeStringContainsQuote:
    'La chaine contient un guillemet (") que le tokenizer ne prend pas en charge.',
  ...
  formulaSerializeCannotParseAbsoluteRowIndex:
    "Impossible d analyser l index de ligne absolu '${variable}'.",
  formulaSerializeCannotMapRowIdToA1Index:
    "Impossible de mapper l id de ligne '${variable}' vers un index A1.",
  formulaEvalRangeNotAllowedInScalarContext:
    'Une plage n est pas autorisee dans un contexte scalaire.',
  ...
  formulaFunctionExpectedExactlyArguments:
    '${variable} : ${variable} arguments exactement attendus.',
  formulaFunctionExpectedAtMostArguments:
    '${variable} : ${variable} arguments au maximum attendus.',
  formulaFunctionExpectedAtLeastArguments:
    '${variable} : ${variable} arguments au minimum attendus.',
  formulaFunctionInvalidCriteriaWildcardsWithComparator:
    'Critere invalide : jokers avec comparateur.',
  ...
  formulaFunctionCannotCombineDatesWithBigInt:
    '${variable} : impossible de combiner des dates avec BigInt.',
  formulaFunctionRequiresAtLeastOneNumericValue:
    '${variable} : au moins une valeur numerique requise.',
  formulaFunctionRequiresAtLeastOneValue:
    '${variable} : au moins une valeur requise.',
  formulaFunctionAllValuesMustBeNumbers:
    '${variable} : toutes les valeurs doivent etre numeriques.',
  formulaFunctionArgumentMustBeRange:
    '${variable} : l argument ${variable} doit etre une plage.',
  formulaFunctionArgumentMustBeValue:
    '${variable} : l argument ${variable} doit etre une valeur.',
  formulaFunctionRangesHaveDifferentSizes:
    '${variable} : les plages ont des tailles differentes.',
  formulaFunctionValuesMustBeNumeric:
    '${variable} : les valeurs doivent etre numeriques.',
  formulaFunctionValuesMustBeIntegers:
    '${variable} : les valeurs doivent etre des entiers.',
  formulaFunctionUnsupportedValueType:
    '${variable} : type de valeur non pris en charge.',
  ...
  formulaFunctionSumCannotCombineDatesWithBigInt:
    'SUM : impossible de combiner des dates avec BigInt.',
  formulaFunctionSumRequiresAtLeastOneNumericValue:
    'SUM : au moins une valeur numerique requise.',
  formulaFunctionAvgRequiresAtLeastOneValue:
    'AVG : au moins une valeur requise.',
  formulaFunctionMedianAllValuesMustBeNumbers:
    'MEDIAN : toutes les valeurs doivent etre numeriques.',
  formulaFunctionMedianRequiresAtLeastOneValue:
    'MEDIAN : au moins une valeur requise.',
  formulaFunctionSumifFirstArgumentMustBeRange:
    'SUMIF : le premier argument doit etre une plage.',
  formulaFunctionSumifSecondArgumentMustBeValue:
    'SUMIF : le deuxieme argument doit etre une valeur (criteria).',
  formulaFunctionSumifThirdArgumentMustBeRange:
    'SUMIF : le troisieme argument doit etre une plage (sum_range).',
  formulaFunctionSumifRangesHaveDifferentSizes:
    'SUMIF : les plages ont des tailles differentes.',
  formulaFunctionCountifFirstArgumentMustBeRange:
    'COUNTIF : le premier argument doit etre une plage.',
  formulaFunctionCountifSecondArgumentMustBeValue:
    'COUNTIF : le deuxieme argument doit etre une valeur (criteria).',
  formulaFunctionConcatUnsupportedValueType:
    'CONCAT : type de valeur non pris en charge.',
  formulaFunctionMinRequiresAtLeastOneValue:
    'MIN : au moins une valeur requise.',
  formulaFunctionMaxRequiresAtLeastOneValue:
    'MAX : au moins une valeur requise.',
  ...
  percentOfGrandTotalDescription:
    'Chaque valeur en pourcentage du total général de la colonne.',
  ...
  percentOfParentRowTotalDescription:
    'Chaque valeur en pourcentage de son groupe parent.',
  percentOfParentColumnTotalDescription:
    'Chaque valeur en pourcentage de sa colonne de tableau croisé parente.',
  ...
  ariaSelectAllCells:
    'Appuyez sur Espace ou Entrée pour sélectionner toutes les cellules',
  ariaSelectAllRowCells:
    'Appuyez sur Entrée pour sélectionner toutes les cellules de cette ligne',
  ...
  ariaColumnGroupExpansion:
    'Appuyez sur ENTER pour développer ou réduire ce groupe de colonnes',
  ...
  ariaSparklineChartDescriptionSingleValue:
    'Sparkline - ${chartType} affichant 1 valeur : ${value}.',
  ariaSparklineChartDescriptionEmpty:
    "Sparkline - ${chartType} n'affichant aucune valeur.",
  ...
  ariaColumnHeaderNameEditor: 'Éditeur de nom de colonne',
  columnHeaderEditApply: 'Appliquer',
  ...
  calculatedColumnExpressionUnknownReference:
    'Référence de colonne inconnue "${variable}".',
