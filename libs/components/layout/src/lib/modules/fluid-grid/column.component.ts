...
export class SkyColumnComponent implements OnInit, OnChanges {
  /**
   * The number of columns (1-12) to use on extra-small screens
  ...
  /**
   * The number of columns (1-12) to use on small screens
  ...
  /**
   * The number of columns (1-12) to use on medium screens
  ...
  /**
   * The number of columns (1-12) to use on large screens
