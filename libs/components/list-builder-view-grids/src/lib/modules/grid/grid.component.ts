  ...
  implements OnInit, AfterContentInit, AfterViewInit, OnChanges, OnDestroy
{
  ...
  @ContentChildren(SkyGridColumnLegacyComponent)
  private columnComponents: QueryList<SkyGridColumnLegacyComponent>;
  ...
  private initColumns(): void {
    ...
    this.columnComponents.forEach((comp: SkyGridColumnLegacyComponent) => {
      this.subscriptions.push(
