...
@Injectable()
export class SkyLineChartRegistry
  implements SkyChartRegistry<SkyLineChartPoint>, SkyChartAxisRegistry
{
  ...
  public upsertSeries(series: SkyChartSeries<SkyLineChartPoint>): void {
  ...
  public upsertPoint(seriesId: number, point: SkyLineChartPoint): void {
    this.series.update((list) =>
      list.map((s) => {
