...
import { getChartJsLineChartConfig } from '../../line-chart/line-chart-config';
import {
  SkyLineChartConfig,
  SkyLineChartPoint,
} from '../../line-chart/line-chart-types';
...
@Component({
  selector: 'sky-line-chart-declarative',
  template: `
...
export class SkyDeclarativeLineChartComponent {
