  ...
  implements AfterContentInit, OnChanges, OnDestroy
{
  ...
  /**
   * A data provider to obtain the data to display. The list component requires
  ...
  /**
   * A set of IDs for the items to select in a checklist or multiselect grid.
  ...
  /**
   * A set of fields to sort by. If array of fields then sorted by order of array.
  ...
  /**
   * A set of filters to apply to list data.
  ...
  /**
   * A function to apply as a global sort on the list.
   */
