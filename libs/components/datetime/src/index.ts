...
export type { SkyDatepickerCalendarChange } from './lib/modules/datepicker/datepicker-calendar-change';
...
export type { SkyFuzzyDate } from './lib/modules/datepicker/fuzzy-date';
