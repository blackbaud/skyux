    ...
    AfterContentInit
{
  ...
  /**
   * Whether to disable the timepicker. This input should not be used with reactive based forms and the disabled state should be set on the `FormControl` instead.
