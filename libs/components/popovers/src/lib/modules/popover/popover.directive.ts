...
export class SkyPopoverDirective implements OnInit, OnDestroy {
   ...
   * @internal
   */
  @HostBinding('class') public directiveClass = 'sky-popover-trigger';

  /**
   * Appends the `sky-popover-id` attribute to the trigger element set to a unique ID generated by the popover component.
   * @internal
   */
  @HostBinding('[attr.sky-popover-id]') public popoverId = 'unknown';
