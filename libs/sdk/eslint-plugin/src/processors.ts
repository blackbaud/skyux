/**
 * Copied (and modified) from https://github.com/angular-eslint/angular-eslint/blob/main/packages/eslint-plugin-template/src/processors.ts.
 */
...
export function isFileLikelyToContainComponentDeclarations(
   ...
   */
  if (
    ['.component.ts', '.component.fixture.ts'].some((likelySuffix) =>
      filename.endsWith(likelySuffix),
    )
  ) {
    return true;
  }
