...
export const LegacyIconReplacements: Record<string, LegacyIconReplacement> = {
  ...
  'arrows-v': { newName: 'arrow-sort' },
  'arrow-up-right-dots': { newName: 'data-line' },
  at: { newName: 'mention' },
  ban: { newName: 'circle-off' },
  ...
  'caret-down': { newName: 'caret-down', variant: 'solid' },
  'caret-left': { newName: 'caret-left' },
  'caret-right': { newName: 'caret-right', variant: 'solid' },
  ...
  'check-square-o': { newName: 'checkmark-square', variant: 'solid' },
  ...
  comment: { newName: 'chat-multiple', variant: 'solid' },
  ...
  info: { newName: 'info' },
  'info-circle': { newName: 'sky-info', variant: 'solid' },
  ...
  'sign-in-alt': { newName: 'door-arrow-right' },
  ...
  th: { newName: 'window-header-horizontal' },
  ...
  'tile-drag': { newName: 'grid-dots' },
  times: { newName: 'dismiss', variant: 'solid' },
